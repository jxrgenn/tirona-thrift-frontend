        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
                ...
                <input 
                    ...
                    className={`w-full bg-[#111] border ${error ? 'border-red-500' : 'border-[#333]'} text-white font-mono py-3 pl-10 pr-4 outline-none focus:border-[#ccff00] transition-colors`}
                />
            </div>

            <button 
                type="submit"
                className="w-full bg-white text-black font-mono font-bold py-3 hover:bg-[#ccff00] transition-colors uppercase"
            >
                Authenticate
            </button>
            ...
            <button 
                type="button" 
                onClick={onCancel}
                className="w-full text-gray-500 font-mono text-xs hover:text-white uppercase mt-4"
            >
                Return to Surface
            </button>
        </form>

                     ...
                     <td className="p-4">
                        <div className="relative inline-block">
                             <select 
                                ...
                                className={`appearance-none outline-none text-[10px] font-bold uppercase pl-6 pr-8 py-1 rounded cursor-pointer transition-colors ${
                                    order.status === 'DELIVERED' ? 'bg-green-900 text-green-300 hover:bg-green-800' : 
